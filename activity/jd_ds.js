...
更新地址：https://gitee.com/washala/jd_scripts/raw/master/jd_ds.js
...
[task_local]
#京东代属
10 7 * * * https://gitee.com/washala/jd_scripts/raw/master/jd_ds.js, tag=京东代属, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jd_ds.png, enabled=true

================Loon==============
[Script]
cron "10 7 * * *" script-path=https://gitee.com/washala/jd_scripts/raw/master/jd_ds.js, tag=京东代属

===============Surge=================
京东代属 = type=cron,cronexp="10 7 * * *",wake-system=1,timeout=3600,script-path=https://gitee.com/washala/jd_scripts/raw/master/jd_ds.js

============小火箭=========
京东代属 = type=cron,script-path=https://gitee.com/washala/jd_scripts/raw/master/jd_ds.js, cronexpr="10 7 * * *", timeout=3600, enable=true
 */
const $ = new Env('京东代属');
