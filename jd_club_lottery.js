...
[task_local]
#摇京豆
5 0,23 * * * https://gitee.com/washala/jd_scripts/raw/master/jd_club_lottery.js, tag=摇京豆, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jdyjd.png, enabled=true
=================Loon===============
[Script]
cron "5 0,23 * * *" script-path=https://gitee.com/washala/jd_scripts/raw/master/jd_club_lottery.js,tag=摇京豆
=================Surge==============
[Script]
摇京豆 = type=cron,cronexp="5 0,23 * * *",wake-system=1,timeout=3600,script-path=https://gitee.com/washala/jd_scripts/raw/master/jd_club_lottery.js

============小火箭=========
摇京豆 = type=cron,script-path=https://gitee.com/washala/jd_scripts/raw/master/jd_club_lottery.js, cronexpr="5 0,23 * * *", timeout=3600, enable=true
*/
